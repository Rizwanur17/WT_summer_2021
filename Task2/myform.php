...
<td>
<input type="checkbox" name= "hobby1" value="Singing"> Music
<input type="checkbox" name= "hobby2" value="Dancing"> Games
<input type="checkbox" name= "hobby3" value="Reading"> Football
</td>
</tr>
 <tr>
 <td>
